  ...
  return (
    <InfoPage eyebrow="Legal" title="Privacy Policy" intro="Effective 26 August 2026. This policy explains what Drop currently collects, why it is used, where it is stored, and when another member can see it.">
      ...
      <section>
        ...
        <p className="mt-3">Public request lists do not include phone numbers, but an active request's detail page publishes the chosen patient-side contact so potential donors can call immediately. The number stops being public when the request is fulfilled, cancelled, or expires. Only submit a contact you have permission to publish. Information you add to comments may be visible publicly, so do not post unrelated phone numbers or sensitive medical details there.</p>
