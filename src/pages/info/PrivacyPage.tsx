  ...
  return (
    <InfoPage eyebrow="Legal" title="Privacy Policy" intro="Effective 26 August 2026. This policy explains what Drop currently collects, why it is used, where it is stored, and when another member can see it.">
      ...
      <section>
        ...
        <p className="mt-3">Public request lists do not include phone numbers, but an active request's detail page publishes the patient's name, the selected broad reason, and the chosen patient-side contact so potential donors can understand the request and call immediately. The patient name and number stop being public when the request is fulfilled, cancelled, or expires. Only submit details you have permission to publish, and do not include a diagnosis or medical report in the broad-reason field. Information you add to comments may be visible publicly, so do not post unrelated phone numbers or sensitive medical details there.</p>
