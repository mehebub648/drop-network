        ...
        <section className="action-dialog donor-summary-dialog" role="dialog" aria-modal="true" aria-labelledby="donor-summary-title">
          ...
          <div className="dialog-actions">
            ...
            {donor.is_current_user ? (
              ...
              <button type="button" onClick={onRequest} disabled={!donor.has_phone || busy} className="button button-primary gap-2"><Phone className="h-4 w-4" aria-hidden="true" />{busy ? 'Opening...' : 'Copy Phone Number'}</button>
            )}
          </div>
        </section>
      </div>
